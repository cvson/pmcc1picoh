...
int main(int argc, char *argv[])
{
    ...
    string fnameout = "../outputs/neutvsgenieMIG_sample_ana1x50mepionFS_3binsptheta.root";
    */
    ...
    string fnameout = "../outputs/genievsneutMIG_sample_ana1x50mepionFS_3binsptheta.root";
