...
int main(int argc, char *argv[])
{
    ...
    string fdtInputFile = "../../datafsipionFS/datamc_neut5d3d2_20170529.root";
    string fnameout = "../outputs/neutvsgenie_sample_ana1x50mepionFS_5binsptheta.root";
    */
    //should change baseTree::GetInteractionType 
    string fmcInputFile = "../../datafsipionFS/mconly_neut5d3d2_pionFSpm_merged_ccqe_addpidFFnew_addnue.root";
    string fdtInputFile = "../../datafsipionFS/mconly_neut5d3d2_20170529.root";
    string fnameout = "../outputs/neut532vsneut_sample_ana1x50mepionFS_5binsptheta_x10stat.root";
