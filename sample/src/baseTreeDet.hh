...
class baseTreeDet {
    ...
    virtual void     MakeSingleHisto(TString ipFile, char* treeName, TString opFile, std::vector<std::pair <double,double> > v_pedges, std::vector<std::pair <double,double> > v_cthedges, Int_t veractShift = 0);
...
Int_t    baseTreeDet::CutSignalR(Long64_t entry){
    ...
    //if (CutPreselection(entry)>0 && pidfsi>0.05 && veract*7.6634e-2<50 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0) {//opt1, opt2, final
...
Int_t    baseTreeDet::CutCR1(Long64_t entry){
    ...
    //if (CutPreselection(entry)>0 && !(pidfsi>0.05) && veract*7.6634e-2<50 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0) {//opt9, final
...
Int_t    baseTreeDet::CutCR23Comb(Long64_t entry){
    ...
    //if (Ntrack>2 && pang<90 && veract*7.6634e-2<50 && pidfsi1prescor>-0.05 && pidfsiccqecor<0.0 && !(mufc==0 && pene<9)) {//final
