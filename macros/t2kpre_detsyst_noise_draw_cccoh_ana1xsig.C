...
void t2kpre_detsyst_noise_draw_cccoh_ana1xsig(){
  ...
  sprintf(FileName_qe1,"detsyst/noise_ana1xsig_nevent_cccoh1_qe.txt");
  sprintf(FileName_nqe1,"detsyst/noise_ana1xsig_nevent_cccoh1_nqe.txt");
  sprintf(OutFile1,"detsyst/noise_ana1xsig_slope_cccoh1.txt");
  //sprintf(FileName_qe2,"detsyst/noise_ana1xsig_nevent_cccoh2_qe.txt");
  //sprintf(FileName_nqe2,"detsyst/noise_ana1xsig_nevent_cccoh2_nqe.txt");
  ...
  titleStyle(g1);
  output1<<res1<<endl;
  c1->Print("detsyst/noise_ana1xsig_graph.eps");
  //c1->Print("detsyst/noise_ana1xsig_graph_rat04.eps");
  //c1->cd(2);
  //float res2 = Draw(g2);
  //output2<<res2<<endl;
}
