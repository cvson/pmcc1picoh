{
    ...
    */
    ...
    //kikawa
    double nevnt_coh_kikawa = hmcen[29][1] ->Integral(0, hmcen[29][1]->GetNbinsX()+1);
    cout<<"Kikawa pass "<<nevnt_coh_kikawa<<" percent "<<nevnt_coh_kikawa*100./nevnt_all<<endl;
    
    //allpass
    double nevnt_coh_allpass = hmcen[32][1] ->Integral(0, hmcen[32][1]->GetNbinsX()+1);
    cout<<"All pass "<<nevnt_coh_allpass<<" percent "<<nevnt_coh_allpass*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_me_not_kikawa = hmcen[30][1] ->Integral(0, hmcen[30][1]->GetNbinsX()+1);
    cout<<"Me-not-kiawa "<<nevnt_coh_me_not_kikawa<<" percent "<<nevnt_coh_me_not_kikawa*100./nevnt_all<<endl;
    
    //not-me-kikawa
    double nevnt_coh_not_me_kikawa = hmcen[31][1] ->Integral(0, hmcen[31][1]->GetNbinsX()+1);
    cout<<"Not-me-kikawa "<<nevnt_coh_not_me_kikawa<<" percent "<<nevnt_coh_not_me_kikawa*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_notall= hmcen[34][1] ->Integral(0, hmcen[34][1]->GetNbinsX()+1);
    ...
    */
    ...
    cout<<"Me pass "<<nevnt_coh_me<<" percent "<<nevnt_coh_me*100./nevnt_all<<endl;
    //kikawa
    double nevnt_coh_kikawa = hmcengenie[29][1] ->Integral(0, hmcengenie[29][1]->GetNbinsX()+1);
    cout<<"Kikawa pass "<<nevnt_coh_kikawa<<" percent "<<nevnt_coh_kikawa*100./nevnt_all<<endl;
    
    //allpass
    double nevnt_coh_allpass = hmcengenie[32][1] ->Integral(0, hmcengenie[32][1]->GetNbinsX()+1);
    cout<<"All pass "<<nevnt_coh_allpass<<" percent "<<nevnt_coh_allpass*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_me_not_kikawa = hmcengenie[30][1] ->Integral(0, hmcengenie[30][1]->GetNbinsX()+1);
    cout<<"Me-not-kiawa "<<nevnt_coh_me_not_kikawa<<" percent "<<nevnt_coh_me_not_kikawa*100./nevnt_all<<endl;
    
    //not-me-kikawa
    double nevnt_coh_not_me_kikawa = hmcengenie[31][1] ->Integral(0, hmcengenie[31][1]->GetNbinsX()+1);
    cout<<"Not-me-kikawa "<<nevnt_coh_not_me_kikawa<<" percent "<<nevnt_coh_not_me_kikawa*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_notall= hmcengenie[34][1] ->Integral(0, hmcengenie[34][1]->GetNbinsX()+1);
    cout<<"Not-all "<<nevnt_coh_notall<<" percent "<<nevnt_coh_notall*100./nevnt_all<<endl;
    ...
    */
    ...
    cout<<"NOM efficiency "<<hmcen[29][1]->Integral(0,hmcen[29][1]->GetNbinsX()+1)*100./hmcen[1][1]->Integral(0,hmcen[1][1]->GetNbinsX()+1)<<endl;
   cout<<"FOR GENIE=================>"<<endl; 
    ...
    cout<<"NOM efficiency "<<hmcengenie[29][1]->Integral(0,hmcengenie[29][1]->GetNbinsX()+1)*100./hmcengenie[1][1]->Integral(0,hmcengenie[1][1]->GetNbinsX()+1)<<endl;
    ...
    TH1F* hefficiency_cutnom = hmcen[29][1]->Clone("hefficiency_cutnom");
    ...
    TH1F* hefficiency_genie_cutnom = hmcengenie[29][1]->Clone("hefficiency_genie_cutnom");
