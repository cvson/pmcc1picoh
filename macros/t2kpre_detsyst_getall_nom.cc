...
void t2kpre_detsyst_getall_nom(){
  float nqeratio[3];
  float err[3][11];
  ...
  ifstream qefile1("detsyst/hiteff_nom_nevent_cccoh1_qe.txt");
  //ifstream qefile2("/home/kikawa/scraid2/MC/pm/hiteff/nevent_cccoh2_qe.txt");
  ifstream nqefile1("detsyst/hiteff_nom_nevent_cccoh1_nqe.txt");
  ...
  //ofstream output("syst_new.txt");
    ofstream output("detsyst/nom_alldetsyst.txt");

    //test from Kikawa'san
    err[0][0] = get_maxdiff("detsyst/nom_ingrid_angle_ccqe1_he.txt",1,nqeratio[0]);
    err[0][1] = get_maxdiff("detsyst/nom_ingrid_position_ccqe1_he.txt",1,nqeratio[0]);
    err[0][2] = get_maxdiff("detsyst/nom_matching_ccqe1_he.txt",1,nqeratio[0]);
    err[0][3] = get_maxdiff("detsyst/nom_vertexingxy_ccqe1_he.txt",1,nqeratio[0]);
    err[0][4] = get_maxdiff("detsyst/nom_vertexingz_ccqe1_he.txt",1,nqeratio[0]);
    err[0][5] = get_maxdiff_timing("detsyst/nom_timing_ccqe1_he.txt",1,nqeratio[0]);
    err[0][6] = get_maxdiff("detsyst/nom_front_veto_ccqe1_he.txt",1,nqeratio[0]);
    err[0][7] = get_maxdiff("detsyst/nom_fv_ccqe1_he.txt",0,nqeratio[0]);
    
  err[0][8] = get_err("detsyst/noise_nom_slope_cccoh1.txt",unoise);
  err[0][9] = get_err("detsyst/hiteff_nom_slope_cccoh1.txt",uhiteff);
  err[0][10]= get_err("detsyst/pe_nom_slope_cccoh1.txt",upe);
