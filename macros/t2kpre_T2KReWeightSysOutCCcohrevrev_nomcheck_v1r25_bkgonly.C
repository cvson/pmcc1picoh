...
float syst[2],tot[2];
  ...
  for(int i=0;i<24;i++){//for v1r25, 25th dial is not used
    for(int j=0;j<7;j++){
      ...
      sprintf(FileName,"/home/cvson/cc1picoh/FIT/versionfsicombgenieana1xpionFS2trksb100mev/macros/t2kreweight_nom_v1r25/nevent%d_cccoh.txt",i*7+j);
