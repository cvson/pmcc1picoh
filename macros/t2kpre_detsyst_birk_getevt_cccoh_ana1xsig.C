...
void t2kpre_detsyst_birk_getevt_cccoh_ana1xsig(){
  ...
  sprintf(Output1,"detsyst/birk_ana1xsig_nevent_cccoh1.txt");
  sprintf(Output2,"detsyst/birk_ana1xsig_nevent_cccoh2.txt");
  sprintf(Output1_cc,"detsyst/birk_ana1xsig_nevent_cccoh1_qe.txt");
  sprintf(Output2_cc,"detsyst/birk_ana1xsig_nevent_cccoh2_qe.txt");
  sprintf(Output1_nc,"detsyst/birk_ana1xsig_nevent_cccoh1_nqe.txt");
  sprintf(Output2_nc,"detsyst/birk_ana1xsig_nevent_cccoh2_nqe.txt");
