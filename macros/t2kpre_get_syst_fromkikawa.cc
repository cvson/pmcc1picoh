#include "/export/scraid5/data2/home_recover/kikawa/macros/cccoh.h"
...
void t2kpre_get_syst_fromkikawa(){
  float nqeratio[3];
  float err[3][11];
  ...
  //ofstream output("syst_new.txt");
    ofstream output("detsyst/syst_fromkikawa.txt");
  ...
  err[0][7] = get_maxdiff("fv_ccqe1_he.txt",0,nqeratio[0]);*/
    ...
    err[0][0] = get_maxdiff("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/ingrid_angle_ccqe1_he.txt",1,nqeratio[0]);
    err[0][1] = get_maxdiff("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/ingrid_position_ccqe1_he.txt",1,nqeratio[0]);
    err[0][2] = get_maxdiff("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/matching_ccqe1_he.txt",1,nqeratio[0]);
    err[0][3] = get_maxdiff("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/vertexingxy_ccqe1_he.txt",1,nqeratio[0]);
    err[0][4] = get_maxdiff("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/vertexingz_ccqe1_he.txt",1,nqeratio[0]);
    err[0][5] = get_maxdiff_timing("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/timing_ccqe1_he.txt",1,nqeratio[0]);
    err[0][6] = get_maxdiff("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/front_veto_ccqe1_he.txt",1,nqeratio[0]);
    err[0][7] = get_maxdiff("/export/scraid5/data2/home_recover/kikawa/macros/detsys_cccoh/fv_ccqe1_he.txt",0,nqeratio[0]);
