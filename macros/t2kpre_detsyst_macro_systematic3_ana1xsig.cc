...
void t2kpre_detsyst_macro_systematic3_ana1xsig(){
...
#ifdef HE
  sprintf(Output1,"detsyst/ana1xsig_timing_ccqe1_he.txt");
  sprintf(Output2,"detsyst/ana1xsig_timing_ccqe2_he.txt");
#endif

#ifdef LE
  sprintf(Output1,"detsyst/ana1xsig_timing_ccqe1_le.txt");
  sprintf(Output2,"detsyst/ana1xsig_timing_ccqe2_le.txt");
#endif
