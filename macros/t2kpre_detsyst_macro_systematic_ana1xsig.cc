...
void t2kpre_detsyst_macro_systematic_ana1xsig(){
  ...
  */
  string fsignal="../../datafsipionFS/numuonly_pionFSpm_merged_ccqe_addpidFFnew_addnue.root";
  string fbar="../../datafsipionFS/nubaronly_pionFSpm_merged_ccqe_addpidFFnew_addnue.root";
  string fdata="../../datafsipionFS/dataonly_pionFSpm_merged_ccqe_addpidFFnew_addnue.root";
  ...
  for(int i=0;i<2;i++){
    ...
    case 0:
      cout<<"FV cut"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_fv_ccqe1_he.txt");
      sprintf(Output2,"detsyst/ana1xsig_fv_ccqe2_he.txt");
      jmax=4;
      break;
    case 1:
      cout<<"Front Veto cut"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_front_veto_ccqe1_he.txt");
      sprintf(Output2,"detsyst/ana1xsig_front_veto_ccqe2_he.txt");
      jmax=3;
      break;
    }
#endif
    ...
    case 0:
      cout<<"FV cut"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_fv_ccqe1_le.txt");
      sprintf(Output2,"detsyst/ana1xsig_fv_ccqe2_le.txt");
      jmax=4;
      break;
    case 1:
      cout<<"Front Veto cut"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_front_veto_ccqe1_le.txt");
      sprintf(Output2,"detsyst/ana1xsig_front_veto_ccqe2_le.txt");
      jmax=3;
      break;
    }
#endif
	...
	break;
...
#ifdef HE
      sprintf(select1,"%s&&%s",cccohmva,select);
      ...
      cout<<"numu "<<fHcc->GetSumOfWeights() <<" nubar "<<fHba->GetSumOfWeights()<<endl;
      //fHdata->Reset();
      //fHcc  ->Reset();
      //fHbg  ->Reset();
      //fHba  ->Reset();
