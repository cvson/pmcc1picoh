...
void t2kpre_detsyst_hiteff_getevt_cccoh_nom(){
  ...
  sprintf(Output1,"detsyst/hiteff_nom_nevent_cccoh1.txt");
  sprintf(Output2,"detsyst/hiteff_nom_nevent_cccoh2.txt");
  sprintf(Output1_cc,"detsyst/hiteff_nom_nevent_cccoh1_qe.txt");
  sprintf(Output2_cc,"detsyst/hiteff_nom_nevent_cccoh2_qe.txt");
  sprintf(Output1_nc,"detsyst/hiteff_nom_nevent_cccoh1_nqe.txt");
  sprintf(Output2_nc,"detsyst/hiteff_nom_nevent_cccoh2_nqe.txt");
