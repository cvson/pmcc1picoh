...
void t2kpre_detsyst_pe_getevt_cccoh_nom(){
  ...
  sprintf(Output1,"detsyst/pe_nom_nevent_cccoh1.txt");
  sprintf(Output2,"detsyst/pe_nom_nevent_cccoh2.txt");
  sprintf(Output1_cc,"detsyst/pe_nom_nevent_cccoh1_qe.txt");
  sprintf(Output2_cc,"detsyst/pe_nom_nevent_cccoh2_qe.txt");
  sprintf(Output1_nc,"detsyst/pe_nom_nevent_cccoh1_nqe.txt");
  sprintf(Output2_nc,"detsyst/pe_nom_nevent_cccoh2_nqe.txt");
