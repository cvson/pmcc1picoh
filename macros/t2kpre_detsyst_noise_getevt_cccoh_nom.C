...
void t2kpre_detsyst_noise_getevt_cccoh_nom(){
  ...
  sprintf(Output1,"detsyst/noise_nom_nevent_cccoh1.txt");
  sprintf(Output2,"detsyst/noise_nom_nevent_cccoh2.txt");
  sprintf(Output1_cc,"detsyst/noise_nom_nevent_cccoh1_qe.txt");
  sprintf(Output2_cc,"detsyst/noise_nom_nevent_cccoh2_qe.txt");
  sprintf(Output1_nc,"detsyst/noise_nom_nevent_cccoh1_nqe.txt");
  sprintf(Output2_nc,"detsyst/noise_nom_nevent_cccoh2_nqe.txt");
  ...
  sprintf(select1,"(%s)*norm*totcrsne*2.8647e-13*6.04193507503274721e20/(986*1.0e21)",cccoh);
  sprintf(select2,"(%s)*norm*totcrsne*2.8647e-13*6.04193507503274721e20/(986*1.0e21)",ccincl);
  sprintf(select1_cc,"(%s&&inttype==16)*norm*totcrsne*2.8647e-13*6.04193507503274721e20/(986*1.0e21)",cccoh);
  sprintf(select2_cc,"(%s&&inttype==1)*norm*totcrsne*2.8647e-13*6.04193507503274721e20/(986*1.0e21)",ccincl);
  sprintf(select1_nc,"(%s&&inttype!=16)*norm*totcrsne*2.8647e-13*6.04193507503274721e20/(986*1.0e21)",cccoh);
  ...
  for(int i=0;i<=15;i++){
    ...
    sprintf(FileName1,"../../systfsi/frKikawa/MC/pm/noise/merged_ccqe_%d.root",i);
    ...
    output1<<i           <<" "<<ndet1_1<<endl;
    output2<<i           <<" "<<ndet1_2<<endl;
    output1_cc<<i           <<" "<<ndet1_1_cc<<endl;
    output2_cc<<i           <<" "<<ndet1_2_cc<<endl;
    output1_nc<<i           <<" "<<ndet1_1_nc<<endl;
    output2_nc<<i           <<" "<<ndet1_2_nc<<endl;
