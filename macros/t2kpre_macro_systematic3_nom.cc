...
void t2kpre_macro_systematic3_nom(){
...
#ifdef HE
  sprintf(Output1,"detsyst/nom_timing_ccqe1_he.txt");
  sprintf(Output2,"detsyst/nom_timing_ccqe2_he.txt");
#endif

#ifdef LE
  sprintf(Output1,"detsyst/nom_timing_ccqe1_le.txt");
  sprintf(Output2,"detsyst/nom_timing_ccqe2_le.txt");
#endif
