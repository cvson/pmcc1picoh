...
void t2kpre_macro_systematic2_nom(){
  ...
  for(int i=0;i<5;i++){
    ...
    case 0:
      ...
      sprintf(Output1,"detsyst/nom_vertexingxy_ccqe1_he.txt");
      sprintf(Output2,"detsyst/nom_vertexingxy_ccqe2_he.txt");
      break;
    case 1:
      cout<<"Vertexing Z"<<endl;
      sprintf(Output1,"detsyst/nom_vertexingz_ccqe1_he.txt");
      sprintf(Output2,"detsyst/nom_vertexingz_ccqe2_he.txt");
      break;
    case 2:
      cout<<"3D matching"<<endl;
      sprintf(Output1,"detsyst/nom_matching_ccqe1_he.txt");
      sprintf(Output2,"detsyst/nom_matching_ccqe2_he.txt");
      break;
    case 3:
      cout<<"INGRID matching position"<<endl;
      sprintf(Output1,"detsyst/nom_ingrid_position_ccqe1_he.txt");
      sprintf(Output2,"detsyst/nom_ingrid_position_ccqe2_he.txt");
      break;
    case 4:
      cout<<"INGRID matching angle"<<endl;
      sprintf(Output1,"detsyst/nom_ingrid_angle_ccqe1_he.txt");
      sprintf(Output2,"detsyst/nom_ingrid_angle_ccqe2_he.txt");
      break;
    }
#endif
    ...
    case 0:
      cout<<"Vertexing XY"<<endl;
      sprintf(Output1,"detsyst/nom_vertexingxy_ccqe1_le.txt");
      sprintf(Output2,"detsyst/nom_vertexingxy_ccqe2_le.txt");
      break;
    case 1:
      cout<<"Vertexing Z"<<endl;
      sprintf(Output1,"detsyst/nom_vertexingz_ccqe1_le.txt");
      sprintf(Output2,"detsyst/nom_vertexingz_ccqe2_le.txt");
      break;
    case 2:
      cout<<"3D matching"<<endl;
      sprintf(Output1,"detsyst/nom_matching_ccqe1_le.txt");
      sprintf(Output2,"detsyst/nom_matching_ccqe2_le.txt");
      break;
    case 3:
      cout<<"INGRID matching position"<<endl;
      sprintf(Output1,"detsyst/nom_ingrid_position_ccqe1_le.txt");
      sprintf(Output2,"detsyst/nom_ingrid_position_ccqe2_le.txt");
      break;
    case 4:
      cout<<"INGRID matching angle"<<endl;
      sprintf(Output1,"detsyst/nom_ingrid_angle_ccqe1_le.txt");
      sprintf(Output2,"detsyst/nom_ingrid_angle_ccqe2_le.txt");
      break;
    }
#endif
