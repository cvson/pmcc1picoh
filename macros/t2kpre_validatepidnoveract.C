{
    ...
    */
    ...
    //me
     cout<<"===================== COH======================="<<endl;
    double nevnt_coh_me = hmcen[2][0] ->Integral(0, hmcen[2][0]->GetNbinsX()+1);
    cout<<"Me pass "<<nevnt_coh_me<<" percent "<<nevnt_coh_me*100./nevnt_all<<endl;
    //kikawa
    double nevnt_coh_kikawa = hmcen[27][0] ->Integral(0, hmcen[27][0]->GetNbinsX()+1);
    cout<<"Kikawa pass "<<nevnt_coh_kikawa<<" percent "<<nevnt_coh_kikawa*100./nevnt_all<<endl;
    
    //allpass
    double nevnt_coh_allpass = hmcen[17][0] ->Integral(0, hmcen[17][0]->GetNbinsX()+1);
    cout<<"All pass "<<nevnt_coh_allpass<<" percent "<<nevnt_coh_allpass*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_me_not_kikawa = hmcen[15][0] ->Integral(0, hmcen[15][0]->GetNbinsX()+1);
    cout<<"Me-not-kiawa "<<nevnt_coh_me_not_kikawa<<" percent "<<nevnt_coh_me_not_kikawa*100./nevnt_all<<endl;
    
    //not-me-kikawa
    double nevnt_coh_not_me_kikawa = hmcen[16][0] ->Integral(0, hmcen[16][0]->GetNbinsX()+1);
    cout<<"Not-me-kikawa "<<nevnt_coh_not_me_kikawa<<" percent "<<nevnt_coh_not_me_kikawa*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_notall= hmcen[19][0] ->Integral(0, hmcen[19][0]->GetNbinsX()+1);
    ...
    */
    ...
    //me
    cout<<"===================== COH======================="<<endl;
    double nevnt_coh_me = hmcengenie[2][0] ->Integral(0, hmcengenie[2][0]->GetNbinsX()+1);
    cout<<"Me pass "<<nevnt_coh_me<<" percent "<<nevnt_coh_me*100./nevnt_all<<endl;
    //kikawa
    double nevnt_coh_kikawa = hmcengenie[27][0] ->Integral(0, hmcengenie[27][0]->GetNbinsX()+1);
    cout<<"Kikawa pass "<<nevnt_coh_kikawa<<" percent "<<nevnt_coh_kikawa*100./nevnt_all<<endl;
    
    //allpass
    double nevnt_coh_allpass = hmcengenie[17][0] ->Integral(0, hmcengenie[17][0]->GetNbinsX()+1);
    cout<<"All pass "<<nevnt_coh_allpass<<" percent "<<nevnt_coh_allpass*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_me_not_kikawa = hmcengenie[15][0] ->Integral(0, hmcengenie[15][0]->GetNbinsX()+1);
    cout<<"Me-not-kiawa "<<nevnt_coh_me_not_kikawa<<" percent "<<nevnt_coh_me_not_kikawa*100./nevnt_all<<endl;
    
    //not-me-kikawa
    double nevnt_coh_not_me_kikawa = hmcengenie[16][0] ->Integral(0, hmcengenie[16][0]->GetNbinsX()+1);
    cout<<"Not-me-kikawa "<<nevnt_coh_not_me_kikawa<<" percent "<<nevnt_coh_not_me_kikawa*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_notall= hmcengenie[19][0] ->Integral(0, hmcengenie[19][0]->GetNbinsX()+1);
    cout<<"Not-all "<<nevnt_coh_notall<<" percent "<<nevnt_coh_notall*100./nevnt_all<<endl;
    ...
    */
    ...
    cout<<"FOR NEUT=================>"<<endl;
    cout<<"TMVA efficiency "<<hmcen[2][0]->Integral(0,hmcen[2][0]->GetNbinsX()+1)*100./hmcen[1][0]->Integral(0,hmcen[1][0]->GetNbinsX()+1)<<endl;
    
    cout<<"NOM efficiency "<<hmcen[27][0]->Integral(0,hmcen[27][0]->GetNbinsX()+1)*100./hmcen[1][0]->Integral(0,hmcen[1][0]->GetNbinsX()+1)<<endl;
   cout<<"FOR GENIE=================>"<<endl; 
    cout<<"TMVA efficiency "<<hmcengenie[2][0]->Integral(0,hmcengenie[2][0]->GetNbinsX()+1)*100./hmcengenie[1][0]->Integral(0,hmcengenie[1][0]->GetNbinsX()+1)<<endl;
    
    cout<<"NOM efficiency "<<hmcengenie[27][0]->Integral(0,hmcengenie[27][0]->GetNbinsX()+1)*100./hmcengenie[1][0]->Integral(0,hmcengenie[1][0]->GetNbinsX()+1)<<endl;
    
    
    TH1F* hefficiency_cutmva = hmcen[2][0]->Clone("hefficiency_cutmva");
    hefficiency_cutmva->Divide(hmcen[1][0]);
    hefficiency_cutmva->Scale(100.);
    
    TH1F* hefficiency_cutnom = hmcen[27][0]->Clone("hefficiency_cutnom");
    ...
    TH1F* hefficiency_genie_cutmva = hmcengenie[2][0]->Clone("hefficiency_genie_cutmva");
    hefficiency_genie_cutmva->Divide(hmcengenie[1][0]);
    hefficiency_genie_cutmva->Scale(100.);
    
    TH1F* hefficiency_genie_cutnom = hmcengenie[27][0]->Clone("hefficiency_genie_cutnom");
    ...
    plot2hist(hefficiency_cutmva,"NEUT",hefficiency_genie_cutmva,"GENIE",subname+varname+"deteff_mva",0.6,0.6);
    plot2hist(hefficiency_cutnom,"NEUT",hefficiency_genie_cutnom,"GENIE",subname+varname+"deteff_nom",0.6,0.6); 
