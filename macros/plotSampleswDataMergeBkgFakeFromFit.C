{
    ...
    const int nsample = 4;
    const char *m_name[] = {"SIG", "CRI", "CRIIB", "More2trk"};
    const char *m_namelong[] = {"Signal", "Control I", "Control IIB", "> two tracks"};
    ...
    for(int isam=0;isam<nsample;isam++){
        ...
        leg0->Draw();
        gPad->Modified();
        //gPad->Print(Form("plots/fakefit_newbin_mergebkg_hdatamc_ccqebin_rec_sam%d.eps",isam));
        gPad->Print(Form("plots/fakefit_newbin_mergebkg_hdatamc_ccqebin_rec_sam%d_newbin2.eps",isam));
