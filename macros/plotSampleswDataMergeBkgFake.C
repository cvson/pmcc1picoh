{
    ...
    TFile *pfile = new TFile("../outputs/mcdata_sample_newbin_fake.root");
    string tag = "nominal";
    ...
    leg0->AddEntry(hccqebin_rec_data[0], "Fake data","lp");
    for (int ireac=0;ireac<nreac;ireac++){
    ...
    leg0->Draw();
    gPad->Print("plots/fake_newbin_mergebkg_dummyLegend.eps");
    ...
    for(int isam=0;isam<nsample;isam++){
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_enu_true_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_enu_rec_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_pmu_rec_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_costh_rec_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_pmu_true_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_costh_true_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_ccqebin_true_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hstach_ccqebin_rec_sam%d.eps",isam));
        ...
        gPad->Modified();
        gPad->Print(Form("plots/fake_newbin_mergebkg_hdatamc_ccqebin_rec_sam%d.eps",isam));
