...
void t2kpre_T2KReWeightGetCCcohRev_ana1x_allmepiless02(int nw = 0){
  ...
  ofstream output(Output);
    ...
    string fnominal = "/export/scraid2/data/cvson/MC/pionFS_pm/merged_pmmc_onlybasic_bugfix.root";//"/home/cvson/cc1picoh/FIT/mc4t2kreweight/merged_onlybasic.root";
    string fweight  = "/home/cvson/scraid2/MC/t2kreweight/v1r19piless02cor/merged_weight.root";//"/home/cvson/cc1picoh/FIT/mc4t2kreweight/merged_weight.root";
    //string fweight  = "/home/cvson/scraid2/MC/t2kreweight/v1r15piless02cor/merged_weight.root";
    ...
    string fccqe  = "/home/cvson/cc1picoh/FIT/datafsipionFS/merged_ccqe_forResponseFunction_pionFS_v1r19piless02cor.root";//newfile
      //string fccqe  = "/home/cvson/cc1picoh/FIT/datafsipionFS/merged_ccqe_forResponseFunction_pionFS_v1r15piless02cor.root";
  TTree* tree_nominal ;
  TTree* tree_ccqe;
  ...
  sprintf(select,"norm*totcrsne*2.8647e-13*6.04193507503274721/(1974*10)");//1974 files 1021 pot
