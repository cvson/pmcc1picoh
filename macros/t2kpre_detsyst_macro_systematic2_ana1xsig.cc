...
void t2kpre_detsyst_macro_systematic2_ana1xsig(){
  ...
  for(int i=0;i<5;i++){
    ...
    case 0:
      ...
      sprintf(Output1,"detsyst/ana1xsig_vertexingxy_ccqe1_he.txt");
      sprintf(Output2,"detsyst/ana1xsig_vertexingxy_ccqe2_he.txt");
      break;
    case 1:
      cout<<"Vertexing Z"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_vertexingz_ccqe1_he.txt");
      sprintf(Output2,"detsyst/ana1xsig_vertexingz_ccqe2_he.txt");
      break;
    case 2:
      cout<<"3D matching"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_matching_ccqe1_he.txt");
      sprintf(Output2,"detsyst/ana1xsig_matching_ccqe2_he.txt");
      break;
    case 3:
      cout<<"INGRID matching position"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_ingrid_position_ccqe1_he.txt");
      sprintf(Output2,"detsyst/ana1xsig_ingrid_position_ccqe2_he.txt");
      break;
    case 4:
      cout<<"INGRID matching angle"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_ingrid_angle_ccqe1_he.txt");
      sprintf(Output2,"detsyst/ana1xsig_ingrid_angle_ccqe2_he.txt");
      break;
    }
#endif
    ...
    case 0:
      cout<<"Vertexing XY"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_vertexingxy_ccqe1_le.txt");
      sprintf(Output2,"detsyst/ana1xsig_vertexingxy_ccqe2_le.txt");
      break;
    case 1:
      cout<<"Vertexing Z"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_vertexingz_ccqe1_le.txt");
      sprintf(Output2,"detsyst/ana1xsig_vertexingz_ccqe2_le.txt");
      break;
    case 2:
      cout<<"3D matching"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_matching_ccqe1_le.txt");
      sprintf(Output2,"detsyst/ana1xsig_matching_ccqe2_le.txt");
      break;
    case 3:
      cout<<"INGRID matching position"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_ingrid_position_ccqe1_le.txt");
      sprintf(Output2,"detsyst/ana1xsig_ingrid_position_ccqe2_le.txt");
      break;
    case 4:
      cout<<"INGRID matching angle"<<endl;
      sprintf(Output1,"detsyst/ana1xsig_ingrid_angle_ccqe1_le.txt");
      sprintf(Output2,"detsyst/ana1xsig_ingrid_angle_ccqe2_le.txt");
      break;
    }
#endif
	...
	break;
      ...
      sprintf(fsignal,"../../systfsi/frKikawa/MC/pm/sys/merged_%d_%d_%d_%d_%d_ccqe.root",thr[0],thr[1],thr[2],thr[3],thr[4]);
      sprintf(fbar,"../../systfsi/frKikawa/MC/pm_bar/sys/merged_%d_%d_%d_%d_%d_ccqe.root",thr[0],thr[1],thr[2],thr[3],thr[4]);
      sprintf(fdata,"../../systfsi/frKikawa/data/sys/merged_%d_%d_%d_%d_%d_ccqe.root",thr[0],thr[1],thr[2],thr[3],thr[4]);
      ...
      tree_bar       -> Project("fHba", "1", Form("reweight(3,nuE)*norm*totcrsne*2.8647e-13*%e/(%d*1e21)*(%s)", npot, nbar, select1) );
      ...
      cout<<" num "<<fHcc->GetSumOfWeights()<<" numubar "<<fHba->GetSumOfWeights()<<endl;
      //fHdata->Reset();
      //fHcc  ->Reset();
      //fHbg  ->Reset();
      //fHbg2  ->Reset();
