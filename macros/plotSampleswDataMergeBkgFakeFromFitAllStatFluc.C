{
    ...
    //TFile *pfile = new TFile("../outputs/testFit_foursample_halfcc1pi.root");
    //TFile *pfile = new TFile("../outputs/testFit_foursample_halfcc1pi_newbin2.root");
    //TFile *pfile = new TFile("../outputs/testFit_sixsample_halfcc1pi_newbin2_wxsecpara.root");
    TFile *pfile = new TFile("../outputs/testFit_sixsample_halfcc1pi_newbin2_wxsecpara_fluxstat.root");
    string tag = "nominal";
    string tagfit = "fit";
    ...
    for(int isam=0;isam<nsample;isam++){
        ...
        leg0->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/allfakefitstatfluc_newbin_mergebkg_hdatamc_ccqebin_rec_sam%d_newbin2.eps",isam));
        ...
        /*if(fHstach_ccqebin_rec_fit[isam]->GetMaximum()> hccqebin_rec_data[isam]->GetMaximum())fHstach_ccqebin_rec_fit[isam]->SetMaximum(fHstach_ccqebin_rec_fit[isam]->GetMaximum()*1.2);
        ...
        leg0->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/allfakefitstatfluc_newbin_mergebkg_hdatamc_ccqebin_rec_fit_sam%d_newbin2.eps",isam));
    }
