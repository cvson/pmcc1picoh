{
    ...
    const char *nameSample_long[]={"Signal sample", "Sideband", "Control I","Control II","Control III", "Control IV"};
    ...
    const char *subname[NSYS] = {"pevar_5bptheta","birks_5bptheta","reco_5bpthetaall","fvtimeall","noise_5bptheta","hiteff_5bptheta"};
    ...
    paFile[0] = new TFile("../inputs/detresponse_pevar_5bptheta_uncertainty.root");
    paFile[1] = new TFile("../inputs/detresponse_birks_5bptheta_uncertainty.root");
    paFile[2] = new TFile("../inputs/detresponse_reco_5bptheta_uncertainty.root");
    paFile[3] = new TFile("../inputs/detresponse_FVTime_5bptheta_newFV_fixReweight.root");
    paFile[4] = new TFile("../inputs/detresponse_noise_5bptheta_uncertainty.root");
    paFile[5] = new TFile("../inputs/detresponse_hiteff_5bptheta_uncertainty.root");
    ...
    for (Int_t icase=0; icase<6; ++icase){
	    ...
	    case 4:
		    ...
		    else if(ipara<(NBINCCQE*4)){
                        cout<<" VALUE "<<pUncertaintyComb[3]->GetY()[ipara-NBINCCQE*3]<<endl;
                        (*cov_det[icase])(ipara,ipara) = pow(pUncertaintyComb[3]->GetY()[ipara-NBINCCQE*3],2);
                    }
                    else{
                        cout<<" VALUE "<<pUncertaintyComb[4]->GetY()[ipara-NBINCCQE*4]<<endl;
                        (*cov_det[icase])(ipara,ipara) = pow(pUncertaintyComb[4]->GetY()[ipara-NBINCCQE*4],2);
                    }
		...
		case 5:
			 ...
			 else if(ipara<(NBINCCQE*5)){
                        cout<<" VALUE "<<pUncertaintyComb[4]->GetY()[ipara-NBINCCQE*4]<<endl;
                        (*cov_det[icase])(ipara,ipara) = pow(pUncertaintyComb[4]->GetY()[ipara-NBINCCQE*4],2);
                    }
                    else{
                        cout<<" VALUE "<<pUncertaintyComb[5]->GetY()[ipara-NBINCCQE*5]<<endl;
                        (*cov_det[icase])(ipara,ipara) = pow(pUncertaintyComb[5]->GetY()[ipara-NBINCCQE*5],2);
                    }
