{
    ...
    TFile *pfile = new TFile("../outputs/neutvsgenie_sample_ana1x50mepionFS_10binsptheta.root");
   ...
   const char *nameslong[] = {"signal", "cc0#pi", "cc1#pi", "ccother", "nc", "numubar", "nue", "ingrid"}; 
    ...
    for(int isam=0;isam<nsample;isam++){
       ...
       leg0->Draw();
        ...
        gPad->Modified();
        gPad->Print(Form("plots/genievsneut_ana1x50mev_pionFS_10binptheta_rec_sam%d.eps",isam));
