{
    ...
    TString subname = "ana2x_effpur_v532_";
    ...
    Int_t topoindex[NTOPOLOGY] = {1,170,29};
    ...
    TH1F* hefficiency_cutmva_cp = (TH1F*)hefficiency_cutmva->Clone("hefficiency_cutmva_cp");
	TH1F* hefficiency_cutnom_cp = (TH1F*)hefficiency_cutnom->Clone("hefficiency_nom_cp");   
 plot2hist(hefficiency_cutmva,"MVA method",hefficiency_cutnom,"Nominal method",subname+varname+"comp_efficiency",0.55,0.6);
    ...
    TH1F* hefficiency_genie_cutmva = hmcengenie[1][1]->Clone("hefficiency_genie_cutmva");
     ...
     hefficiency_cutnom_cp->GetXaxis()->SetTitle(xtitle);
     hefficiency_cutnom_cp->GetYaxis()->SetTitle("Signal efficiency (%)");
     hefficiency_cutnom_cp->GetXaxis()->SetRangeUser(0,rangemax);
     hefficiency_cutnom_cp->GetYaxis()->SetRangeUser(0,effmax);

     
    plot3histStyle1(false,hefficiency_cutmva_cp,"NEUT 5.3.2",hefficiency_v5142_cutmva,"NEUT 5.1.4.2",hefficiency_genie_cutmva,"GENIE",subname+varname+"comp3mva_efficiency",0.55,0.6);
    
    plot3histStyle1(false,hefficiency_cutnom_cp,"NEUT 5.3.2",hefficiency_v5142_cutnom,"NEUT 5.1.4.2",hefficiency_genie_cutnom,"GENIE",subname+varname+"comp3nom_efficiency",0.55,0.6);
