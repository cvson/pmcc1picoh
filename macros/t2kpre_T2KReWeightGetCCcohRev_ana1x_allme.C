...
void t2kpre_T2KReWeightGetCCcohRev_ana1x_allme(int nw = 0){
  ...
  ofstream output(Output);
    ...
    string fweight  = "/home/cvson/scraid2/MC/t2kreweight/v1r19/merged_weight.root";//"/home/cvson/cc1picoh/FIT/mc4t2kreweight/merged_weight.root";
