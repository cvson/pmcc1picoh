...
void t2kpre_detsyst_hiteff_draw_cccoh_nom(){
  ...
  sprintf(FileName_qe1,"detsyst/hiteff_nom_nevent_cccoh1_qe.txt");
  sprintf(FileName_nqe1,"detsyst/hiteff_nom_nevent_cccoh1_nqe.txt");
  sprintf(OutFile1,"detsyst/hiteff_nom_slope_cccoh1.txt");
  //sprintf(FileName_qe2,"detsyst/hiteff_nom_nevent_cccoh2_qe.txt");
  //sprintf(FileName_nqe2,"detsyst/hiteff_nom_nevent_cccoh2_nqe.txt");
  ...
  output1<<res1<<endl;
  titleStyle(g1);
  c1->Print("detsyst/hiteff_nom_graph.eps");
  //c1->cd(2);
  //float res2 = Draw(g2);
  //output2<<res2<<endl;
}
