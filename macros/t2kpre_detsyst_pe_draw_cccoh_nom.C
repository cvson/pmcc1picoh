...
void t2kpre_detsyst_pe_draw_cccoh_nom(){
  ...
  sprintf(FileName_qe1,"detsyst/pe_nom_nevent_cccoh1_qe.txt");
  sprintf(FileName_nqe1,"detsyst/pe_nom_nevent_cccoh1_nqe.txt");
  sprintf(OutFile1,"detsyst/pe_nom_slope_cccoh1.txt");
  //sprintf(FileName_qe2,"detsyst/pe_nom_nevent_cccoh2_qe.txt");
  //sprintf(FileName_nqe2,"detsyst/pe_nom_nevent_cccoh2_nqe.txt");
  ...
  output1<<res1<<endl;
  titleStyle(g1);
  gPad->Print("detsyst/pe_nom_graph.eps");
  //c1->cd(2);
  //float res2 = Draw(g2);
  //output2<<res2<<endl;
}
