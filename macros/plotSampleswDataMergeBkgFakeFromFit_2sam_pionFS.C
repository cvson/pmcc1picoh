{
    ...
    TFile *pfile = new TFile("../outputs/two/fittoy_result_1_xseconly.root");
    string tag = "nominal";
    string tagfit = "fit";
    ...
    for(int isam=0;isam<nsample;isam++){
        ...
        leg0->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/allfakefit_5bptheta_hdatamc_ccqebin_rec_sam%d.eps",isam));
        ...
        leg0->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/allfakefit_5bptheta_hdatamc_ccqebin_rec_fit_sam%d.eps",isam));
    }
