{
    ...
    TFile *pfile = new TFile("../outputs/sample_nominal.root");
    string tag = "nominal";
    ...
    for(int isam=0;isam<nsample;isam++){
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_enu_true_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_enu_rec_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_pmu_rec_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_costh_rec_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_pmu_true_sam%d.eps",isam));
        ...
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_costh_true_sam%d.eps",isam));
        
        
        new TCanvas;
        fHstach_ccqebin_true[isam]->Draw();
        fHstach_ccqebin_true[isam]->GetXaxis()->SetTitle("True CCQE bins");
        fHstach_ccqebin_true[isam]->GetYaxis()->SetTitle("Number of Events");
        titleStyle(fHstach_ccqebin_true[isam]);
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_ccqebin_true_sam%d.eps",isam));
        
        new TCanvas;
        fHstach_ccqebin_rec[isam]->Draw();
        fHstach_ccqebin_rec[isam]->GetXaxis()->SetTitle("Reconstructed CCQE bins");
        fHstach_ccqebin_rec[isam]->GetYaxis()->SetTitle("Number of Events");
        titleStyle(fHstach_ccqebin_rec[isam]);
        tlx->Draw();
        gPad->Modified();
        gPad->Print(Form("plots/hstach_ccqebin_rec_sam%d.eps",isam));
    }
    
    //Dummy TLegend
    new TCanvas;
    TLegend* leg0 = new TLegend(.32, .32, 0.85, .85);
    ...
    leg0->Draw();
    gPad->Print("plots/dummyLegend.eps");
