{
    ...
    */
    TString subname = "ana1x_pidvalidate_";    
    ...
    */
    ...
    for (Int_t itopo=0; itopo<NTOPOLOGY; ++itopo) {
        ...
        hdata[itopo] = (TH1F*)pfile->Get(Form("hdata_topo%d_var%d",itopo,thvariable));
    ...
    double nevnt_all_data = hdata[1] ->Integral(0, hdata[1]->GetNbinsX()+1);
    cout<<"Total DATA "<<nevnt_all_data<<endl;

    //CC1picoh
    //me
    /* cout<<"===================== COH======================="<<endl;
    double nevnt_coh_me = hmcen[20][0] ->Integral(0, hmcen[20][0]->GetNbinsX()+1);
    cout<<"Me pass "<<nevnt_coh_me<<" percent "<<nevnt_coh_me*100./nevnt_all<<endl;
    
    double nevnt_coh_me_data = hdata[20] ->Integral(0, hdata[20]->GetNbinsX()+1);
    cout<<"Me pass DATA "<<nevnt_coh_me_data<<" percent "<<nevnt_coh_me_data*100./nevnt_all_data<<endl;
    
    //kikawa
    double nevnt_coh_kikawa = hmcen[26][0] ->Integral(0, hmcen[26][0]->GetNbinsX()+1);
    cout<<"Kikawa pass "<<nevnt_coh_kikawa<<" percent "<<nevnt_coh_kikawa*100./nevnt_all<<endl;

    double nevnt_coh_kikawa_data = hdata[26] ->Integral(0, hdata[26]->GetNbinsX()+1);
    cout<<"Kikawa pass DATA "<<nevnt_coh_kikawa_data<<" percent "<<nevnt_coh_kikawa_data*100./nevnt_all_data<<endl;
    
    //allpass
    double nevnt_coh_allpass = hmcen[24][0] ->Integral(0, hmcen[24][0]->GetNbinsX()+1);
    cout<<"All pass "<<nevnt_coh_allpass<<" percent "<<nevnt_coh_allpass*100./nevnt_all<<endl;

    double nevnt_coh_allpass_data = hdata[24] ->Integral(0, hdata[24]->GetNbinsX()+1);
    cout<<"All pass DATA "<<nevnt_coh_allpass_data<<" percent "<<nevnt_coh_allpass_data*100./nevnt_all_data<<endl;

    
    //me-not-kikawa
    double nevnt_coh_me_not_kikawa = hmcen[22][0] ->Integral(0, hmcen[22][0]->GetNbinsX()+1);
    cout<<"Me-not-kiawa "<<nevnt_coh_me_not_kikawa<<" percent "<<nevnt_coh_me_not_kikawa*100./nevnt_all<<endl;

    double nevnt_coh_me_not_kikawa_data = hdata[22] ->Integral(0, hdata[22]->GetNbinsX()+1);
    cout<<"Me-not-kiawa DATA "<<nevnt_coh_me_not_kikawa_data<<" percent "<<nevnt_coh_me_not_kikawa_data*100./nevnt_all_data<<endl;
    
    //not-me-kikawa
    double nevnt_coh_not_me_kikawa = hmcen[23][0] ->Integral(0, hmcen[23][0]->GetNbinsX()+1);
    cout<<"Not-me-kikawa "<<nevnt_coh_not_me_kikawa<<" percent "<<nevnt_coh_not_me_kikawa*100./nevnt_all<<endl;
   
    double nevnt_coh_not_me_kikawa_data = hdata[23] ->Integral(0, hdata[23]->GetNbinsX()+1);
    cout<<"Not-me-kikawa DATA "<<nevnt_coh_not_me_kikawa_data<<" percent "<<nevnt_coh_not_me_kikawa_data*100./nevnt_all_data<<endl;
 
    //me-not-kikawa
    double nevnt_coh_notall= hmcen[25][0] ->Integral(0, hmcen[25][0]->GetNbinsX()+1);
    cout<<"Not-all "<<nevnt_coh_notall<<" percent "<<nevnt_coh_notall*100./nevnt_all<<endl;

    double nevnt_coh_notall_data= hdata[25] ->Integral(0, hdata[25]->GetNbinsX()+1);
    cout<<"Not-all DATA "<<nevnt_coh_notall_data<<" percent "<<nevnt_coh_notall_data*100./nevnt_all_data<<endl;
    */
    ...
    //me
    cout<<"===================== COH======================="<<endl;
    double nevnt_coh_me = hmcengenie[20][0] ->Integral(0, hmcengenie[20][0]->GetNbinsX()+1);
    cout<<"Me pass "<<nevnt_coh_me<<" percent "<<nevnt_coh_me*100./nevnt_all<<endl;
   
    //kikawa
    double nevnt_coh_kikawa = hmcengenie[26][0] ->Integral(0, hmcengenie[26][0]->GetNbinsX()+1);
    cout<<"Kikawa pass "<<nevnt_coh_kikawa<<" percent "<<nevnt_coh_kikawa*100./nevnt_all<<endl;
    
    //allpass
    double nevnt_coh_allpass = hmcengenie[24][0] ->Integral(0, hmcengenie[24][0]->GetNbinsX()+1);
    cout<<"All pass "<<nevnt_coh_allpass<<" percent "<<nevnt_coh_allpass*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_me_not_kikawa = hmcengenie[22][0] ->Integral(0, hmcengenie[22][0]->GetNbinsX()+1);
    cout<<"Me-not-kiawa "<<nevnt_coh_me_not_kikawa<<" percent "<<nevnt_coh_me_not_kikawa*100./nevnt_all<<endl;
    
    //not-me-kikawa
    double nevnt_coh_not_me_kikawa = hmcengenie[23][0] ->Integral(0, hmcengenie[23][0]->GetNbinsX()+1);
    cout<<"Not-me-kikawa "<<nevnt_coh_not_me_kikawa<<" percent "<<nevnt_coh_not_me_kikawa*100./nevnt_all<<endl;
    
    //me-not-kikawa
    double nevnt_coh_notall= hmcengenie[25][0] ->Integral(0, hmcengenie[25][0]->GetNbinsX()+1);
    cout<<"Not-all "<<nevnt_coh_notall<<" percent "<<nevnt_coh_notall*100./nevnt_all<<endl;
    ...
    */
    ...
    cout<<"FOR NEUT=================>"<<endl;
    cout<<"TMVA efficiency "<<hmcen[20][0]->Integral(0,hmcen[20][0]->GetNbinsX()+1)*100./hmcen[1][0]->Integral(0,hmcen[1][0]->GetNbinsX()+1)<<endl;
    
    cout<<"NOM efficiency "<<hmcen[26][0]->Integral(0,hmcen[26][0]->GetNbinsX()+1)*100./hmcen[1][0]->Integral(0,hmcen[1][0]->GetNbinsX()+1)<<endl;
   cout<<"FOR GENIE=================>"<<endl; 
    cout<<"TMVA efficiency "<<hmcengenie[20][0]->Integral(0,hmcengenie[20][0]->GetNbinsX()+1)*100./hmcengenie[1][0]->Integral(0,hmcengenie[1][0]->GetNbinsX()+1)<<endl;
    
    cout<<"NOM efficiency "<<hmcengenie[26][0]->Integral(0,hmcengenie[26][0]->GetNbinsX()+1)*100./hmcengenie[1][0]->Integral(0,hmcengenie[1][0]->GetNbinsX()+1)<<endl;
    
    
    TH1F* hefficiency_cutmva = hmcen[20][0]->Clone("hefficiency_cutmva");
    hefficiency_cutmva->Divide(hmcen[1][0]);
    hefficiency_cutmva->Scale(100.);
    
    TH1F* hefficiency_cutnom = hmcen[26][0]->Clone("hefficiency_cutnom");
    hefficiency_cutnom->Divide(hmcen[1][0]);
    hefficiency_cutnom->Scale(100.);
    
    TH1F* hefficiency_cutmva_data = hdata[20]->Clone("hefficiency_cutmva_data");
    hefficiency_cutmva_data->Divide(hdata[1]);
    hefficiency_cutmva_data->Scale(100.);

    TH1F* hefficiency_cutnom_data = hdata[26]->Clone("hefficiency_cutnom_data");
    hefficiency_cutnom_data->Divide(hdata[1]);
    ...
    */
    ...
    TH1F* hefficiency_genie_cutmva = hmcengenie[20][0]->Clone("hefficiency_genie_cutmva");
    hefficiency_genie_cutmva->Divide(hmcengenie[1][0]);
    hefficiency_genie_cutmva->Scale(100.);
    
    TH1F* hefficiency_genie_cutnom = hmcengenie[26][0]->Clone("hefficiency_genie_cutnom");
