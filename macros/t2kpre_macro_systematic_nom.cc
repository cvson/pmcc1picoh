...
void t2kpre_macro_systematic_nom(){
  ...
  for(int i=0;i<2;i++){
    ...
    case 0:
      cout<<"FV cut"<<endl;
      sprintf(Output1,"detsyst/nom_fv_ccqe1_he.txt");
      sprintf(Output2,"detsyst/nom_fv_ccqe2_he.txt");
      jmax=4;
      break;
    case 1:
      cout<<"Front Veto cut"<<endl;
      sprintf(Output1,"detsyst/nom_front_veto_ccqe1_he.txt");
      sprintf(Output2,"detsyst/nom_front_veto_ccqe2_he.txt");
      jmax=3;
      break;
    }
#endif
    ...
    case 0:
      cout<<"FV cut"<<endl;
      sprintf(Output1,"detsyst/nom_fv_ccqe1_le.txt");
      sprintf(Output2,"detsyst/nom_fv_ccqe2_le.txt");
      jmax=4;
      break;
    case 1:
      cout<<"Front Veto cut"<<endl;
      sprintf(Output1,"detsyst/nom_front_veto_ccqe1_le.txt");
      sprintf(Output2,"detsyst/nom_front_veto_ccqe2_le.txt");
      jmax=3;
      break;
    }
#endif
	...
	break;
      ...
      cout<<"numu "<<fHcc->GetSumOfWeights() + fHba->GetSumOfWeights()<<" nubar "<<fHba->GetSumOfWeights()<<endl;
      //fHdata->Reset();
      //fHcc  ->Reset();
      //fHbg  ->Reset();
      //fHba  ->Reset();
